...
public class SixthQuestion extends BaseTest {
	...
	public void verifyNavigationAndClick() throws InterruptedException {
		Thread.sleep(2000);
		String expectedTitle = "Autify";
		...
		action.moveToElement(pricing).click().build().perform();
	...
	public void verifyErrorMessage(){
		...
		Assert.assertTrue(errorMessage.size() >0 , "ErrorMessage Not Displayed");
