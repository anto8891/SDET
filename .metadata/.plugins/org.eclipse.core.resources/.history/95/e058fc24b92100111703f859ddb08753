...
public class FifthQuestion {
	 ...
	 public void laumchBrowser() throws InterruptedException {
		 ...
		 action.moveToElement(pricing).build().perform();			
			...
			WebElement getStarted = driver.findElement(By.xpath("//*[@id=\"w-tabs-0-data-w-pane-0\"]/div[2]/div[1]/div[1]/a"));
			...
			driver.get(linkUrl);
			Thread.sleep(1000);
			WebElement TryforFree = driver.findElement(By.xpath("//*[@id=\"hsForm_61331049-73d0-4fe7-b86e-a88740bd6c4f\"]/div/div[2]/input"));
			action.moveToElement(TryforFree).build().perform();	
			TryforFree.click();
			action.moveToElement(TryforFree).build().perform();	
			String expectedError = "Please complete this required field.";
			
			List<WebElement> errorMessage = driver.findElements(By.xpath("//*[contains(text(), 'Please complete this required field.')]"));
			...
			//tryFree.click();
			  ...
			  driver.switchTo().window(mainWindow); Thread.sleep(1000);
			  ...
			  for (String windowHandle : allwindows)
			  {
				  if(!windowHandle.equals(mainWindow))
				  {
					  ...
					  System.out.println("Current URL :" + driver.getCurrentUrl()); driver.close();
